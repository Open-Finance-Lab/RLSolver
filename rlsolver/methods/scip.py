...
def run_scip_manyfiles(prefixes: List[str], time_limits: List[int], data_dir: str = 'data', result_dir: str = './result'):
...
if __name__ == '__main__':
    ...
    result_dir = '../result'
    run_scip_manyfiles(prefixes, time_limits, data_dir, result_dir)
    avg_std = calc_avg_std_of_objs(result_dir, prefixes, time_limits)
    pass
