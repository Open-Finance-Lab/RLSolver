...
rlsolver_dir = os.path.join(cur_path, '../../rlsolver')
sys.path.append(os.path.dirname(rlsolver_dir))
...
def run_trial(run_id):
    rlsolver_root = project_root.parent.parent
    inst = rlsolver_root / "data" / "gset" / "gset_14.txt"
